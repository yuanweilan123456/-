...
function renderStaticShell(page: SeoPageDefinition) {
  return `<div id="app"><div class="prerender-shell" data-prerendered-route="${escapeHtml(page.path)}">
    <header><a class="prerender-brand" href="/">FileTools</a><nav aria-label="Main navigation"><a href="/">All tools</a><a href="/guides">Guides</a><a href="/faq">FAQ</a><a href="/how-we-test">How we test</a><a href="/contact">Contact</a></nav></header>
    ...
    <footer><a href="/how-we-test">How we test</a><a href="/contact">Contact</a><a href="/privacy">Privacy</a><a href="/terms">Terms</a><p>Free browser-local file tools from FileTools.</p></footer>
  </div></div>`
}
