...
describe('file toolbox helpers', () => {
  ...
  it('converts a minimal DOCX document to HTML', async () => {
    ...
    docx.file('word/document.xml', '<?xml version="1.0" encoding="UTF-8"?><w:document xmlns:w="http://schemas.openxmlformats.org/wordprocessingml/2006/main"><w:body><w:p><w:r><w:t>PixelForge test</w:t></w:r></w:p><w:sectPr/></w:body></w:document>')
